# e-supplier agent — pilnais apraksts
...
Īsais ceļš — uzstādīšana, `.env` un komandu saraksts — ir
**[README.md](README.md)**. Pilna uzstādīšana no tukšas mašīnas, pārbaudes soļi
un kļūdu ceļi — **[SETUP.md](SETUP.md)**. Šis fails ir par to, kā aģents strādā.
